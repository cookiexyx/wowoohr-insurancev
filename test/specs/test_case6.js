          ...
          .isVisible('body > ng-view > div > div.ng-scope > div.insuranceAddCont > div.insuranceAdd-policy > div.no-insuranceAdd-policy', function(result) {
            if(result.value){
              this
                ...
                .pause(2000)
                .getText("#errorPromte", function(result){
                  this.assert.equal(result.value, '社保公积金产品缺少公积金险种')
                })
                .pause(5000)
                .click('body > ng-view > div > div.ng-scope > div.insuranceAddCont > div.insuranceAdd-policy > div.insuranceAdd-policy-cont > div.insuranceAdd-policy-head.clearfix > button')
                .pause(1000)
                ...
                .click('body > ng-view > div > div.pop.insurance-pop-month.insurance-pop-add > ul > li:nth-child(1) > select option[value="6"]')
                .getText("body > ng-view > div > div.pop.insurance-pop-month.insurance-pop-add > ul > li:nth-child(3) > select", function(result) {
                  this.assert.equal(result.value, '月收')
                })
                .assert.value('body > ng-view > div > div.pop.insurance-pop-month.insurance-pop-add > ul > li:nth-child(3) > select', '2')
