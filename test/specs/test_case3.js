  ...
  'tests_case3': function (browser) {   
    ...
    browser
      ...
      .getText(".insurance-fund-box", function(result) {
        ...
        this
          .assert.urlContains('insurance/add')
          .assert.value('body > ng-view > div > div.ng-scope > div.insuranceAddCont > div.insuranceAddBasic > div:nth-child(1) > div.rightaddbug > select', 'string:1')
          .assert.value('body > ng-view > div > div.ng-scope > div.insuranceAddCont > div.insuranceAddBasic > div:nth-child(2) > div.rightaddbug > select', 'string:210200')
          .getText("body > ng-view > div > div.ng-scope > div.insuranceAddCont > div.insuranceAddBasic > div:nth-child(1) > div.rightaddbug > select", function(result) {
            this.assert.equal(result.value, '社保\n公积金\n社保公积金')
          })
          .getText("body > ng-view > div > div.ng-scope > div.insuranceAddCont > div.insuranceAddBasic > div:nth-child(2) > div.rightaddbug > select", function(result) {
            this.assert.equal(result.value, '大连\n上海\n苏州\n厦门\n武汉\n广州\n深圳')
          })
          ...
          .assert.value('.insuranceAddCont input[name=conscience]', '2')
          .click('body > ng-view > div > div.ng-scope > div.insuranceAddCont > div.insuranceAddBasic > button')
          .pause(1000)
          .getText("body > ng-view > div > div.ng-scope > div.insuranceAddCont > div.insuranceAdd-cenbao > div:nth-child(1) > label:nth-child(1)", function(result) {
            this.assert.equal(result.value, '户籍属性')
          })
          .getText("body > ng-view > div > div.ng-scope > div.insuranceAddCont > div.insuranceAdd-cenbao > div:nth-child(1) > label:nth-child(2)", function(result) {
            this.assert.equal(result.value, '户籍所在地')
          })
          .getText("body > ng-view > div > div.ng-scope > div.insuranceAddCont > div.insuranceAdd-cenbao > div:nth-child(1) > label:nth-child(3)", function(result) {
            this.assert.equal(result.value, '学历')
          })
          .getText("body > ng-view > div > div.ng-scope > div.insuranceAddCont > div.insuranceAdd-cenbao > div:nth-child(2) > label:nth-child(1)", function(result) {
            this.assert.equal(result.value, '户籍属性')
          })
          .getText("body > ng-view > div > div.ng-scope > div.insuranceAddCont > div.insuranceAdd-cenbao > div:nth-child(2) > label:nth-child(2)", function(result) {
            this.assert.equal(result.value, '户籍所在地')
          })
          .getText("body > ng-view > div > div.ng-scope > div.insuranceAddCont > div.insuranceAdd-cenbao > div:nth-child(2) > label:nth-child(3)", function(result) {
            this.assert.equal(result.value, '学历')
          })
          ...
          .isVisible('body > ng-view > div > div.ng-scope > div.insuranceAddCont > div.insuranceAdd-policy > div.no-insuranceAdd-policy', function(result) {
            if(result.value){
              this
                ...
                .pause(1000)
                .assert.visible("body > ng-view > div > div.pop.insurance-pop-month.insurance-pop-add")
                .pause(1000)
